                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-2xl">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-300 text-sm">Use o formulário ao lado selecionando "Sugestão de Matéria" no assunto.</p>
                                </div>
                                
                                <div>
                                    <h3 class="text-lg font-semibold text-white mb-2">Vocês aceitam colaboradores?</h3>
                                    <p class="text-gray-300 text-sm">Sim! Envie uma mensagem com "Colaboração" no assunto.</p>
                                </div>
                                
                                <div>
                                    <h3 class="text-lg font-semibold text-white mb-2">Como fazer parcerias?</h3>
                                    <p class="text-gray-300 text-sm">Para parcerias comerciais, selecione "Parceria" no assunto.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
const headData = ref({
    ...
    meta: [
        { name: 'description', content: 'Entre em contato conosco. Sugestões, parcerias, colaborações e mais.' },
        { name: 'keywords', content: 'contato, proplaynews, sugestões, parcerias, games' },
    ],
});
