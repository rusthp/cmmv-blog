...
function getFullTitle(t: any): string {
    ...
    const name = t.name || '';
    // If name is generic like "Playoffs", prefix with league
...
.info-value.prize-slot-info {
    color: #63b3ed;
}

.stat-value.prize-slot {
    color: #63b3ed;
}
...
/* Loading/Error */
.loading-page, .error-page, .not-found {
    display: flex;
    align-items: center;
    justify-content: center;
    min-height: 60vh;
