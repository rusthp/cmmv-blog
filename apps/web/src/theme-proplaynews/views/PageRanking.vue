...
const LM = 'https://raw.githubusercontent.com/lootmarket/esport-team-logos/master/csgo';
const KNOWN_LOGOS: Record<string, string> = {
    'vitality': 'https://upload.wikimedia.org/wikipedia/commons/1/1a/Team_Vitality_logo.svg',
    'furia': `${LM}/furia/furia-logo.png`,
    'mouz': 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Mouz_logo.svg',
    'mousesports': `${LM}/mousesports/mousesports-logo.png`,
    ...
    'spirit': `${LM}/spirit/spirit-logo.png`,
    'team spirit': `${LM}/spirit/spirit-logo.png`,
    'g2': 'https://upload.wikimedia.org/wikipedia/en/3/3c/G2_Esports_logo.svg',
    'g2 esports': 'https://upload.wikimedia.org/wikipedia/en/3/3c/G2_Esports_logo.svg',
    ...
    'the mongolz': `${LM}/the-mongolz/the-mongolz-logo.png`,
    ...
    'big': `${LM}/big/big-logo.png`,
    'ence': 'https://upload.wikimedia.org/wikipedia/en/1/1e/ENCE_logo.svg',
    'imperial': `${LM}/imperial/imperial-logo.png`,
    'imperial esports': `${LM}/imperial/imperial-logo.png`,
    'mibr': `${LM}/mibr/mibr-logo.png`,
    'made in brazil': `${LM}/mibr/mibr-logo.png`,
    'pain': 'https://upload.wikimedia.org/wikipedia/en/3/3f/PaiN_Gaming_logo.svg',
    'pain gaming': `${LM}/pain-gaming/pain-gaming-logo.png`,
    'gamerlegion': `${LM}/gamerlegion/gamerlegion-logo.png`,
    'parivision': `${LM}/parivision/parivision-logo.png`,
    // Additional teams
    'aurora': `${LM}/aurora/aurora-logo.png`,
    'falcons': `${LM}/falcons/falcons-logo.png`,
    'monte': `${LM}/monte/monte-logo.png`,
    'spirit academy': `${LM}/spirit/spirit-logo.png`,
    'betboom': `${LM}/betboom/betboom-logo.png`,
    'betboom team': `${LM}/betboom/betboom-logo.png`,
    'b8': `${LM}/b8/b8-logo.png`,
    'nrg': `${LM}/nrg/nrg-logo.png`,
    '3dmax': `${LM}/3dmax/3dmax-logo.png`,
    'k27': `${LM}/k27/k27-logo.png`,
    'sharks': `${LM}/sharks/sharks-logo.png`,
    'sharks esports': `${LM}/sharks/sharks-logo.png`,
    'gentle mates': `${LM}/gentle-mates/gentle-mates-logo.png`,
    'ecstatic': `${LM}/ecstatic/ecstatic-logo.png`,
    'flyquest': `${LM}/flyquest/flyquest-logo.png`,
    'legacy': `${LM}/legacy/legacy-logo.png`,
    'alliance': `${LM}/alliance/alliance-logo.png`,
    'nemiga': `${LM}/nemiga/nemiga-logo.png`,
    'illwill': `${LM}/illwill/illwill-logo.png`,
    'm80': `${LM}/m80/m80-logo.png`,
    'hotu': `${LM}/hotu/hotu-logo.png`,
    'red canids': `${LM}/red-canids/red-canids-logo.png`,
    '100 thieves': `${LM}/100-thieves/100-thieves-logo.png`,
    'bestia': `${LM}/bestia/bestia-logo.png`,
    '9ine': `${LM}/9ine/9ine-logo.png`,
    'bc.game': `${LM}/bc-game/bc-game-logo.png`,
    'whitebird': `${LM}/whitebird/whitebird-logo.png`,
    '9z': 'https://upload.wikimedia.org/wikipedia/commons/d/de/9z_Team_logo.png',
    '9z team': 'https://upload.wikimedia.org/wikipedia/commons/d/de/9z_Team_logo.png',
    'fut': 'https://upload.wikimedia.org/wikipedia/commons/9/9c/FUT_Esports_logo.png',
    'fut esports': 'https://upload.wikimedia.org/wikipedia/commons/9/9c/FUT_Esports_logo.png',
    'sinners': 'https://upload.wikimedia.org/wikipedia/commons/c/c6/Sinners_Esports_logo.png',
    'gaimin gladiators': 'https://upload.wikimedia.org/wikipedia/commons/e/e3/Gaimin_Gladiators_logo.png',
    'passion ua': 'https://upload.wikimedia.org/wikipedia/commons/2/26/Passion_UA_logo.png',
    'tyloo': 'https://upload.wikimedia.org/wikipedia/en/e/ef/TYLOO_logo.png',
    'lynn vision': 'https://upload.wikimedia.org/wikipedia/commons/9/93/Lynn_Vision_Gaming_logo.png',
    'thunder downunder': 'https://upload.wikimedia.org/wikipedia/commons/8/88/ThunderTalk_Gaming_logo.png',
    'eyeballers': 'https://upload.wikimedia.org/wikipedia/en/1/18/EYEBALLERS_logo.svg',
};
