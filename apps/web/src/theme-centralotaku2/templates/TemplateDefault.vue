<template>
    ...
    <!-- Newsletter Section -->
    <section class="py-12 bg-neutral-100 dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800" aria-labelledby="newsletter-heading">
        <div class="container mx-auto px-4 text-center">
            <h2 id="newsletter-heading" class="text-2xl font-bold text-neutral-800 dark:text-neutral-100 mb-2">Receba as novidades</h2>
            ...
            <div v-if="newsletterSubmitted" class="max-w-md mx-auto bg-green-50 border border-green-200 rounded-lg p-4 mb-4" role="alert" aria-live="polite">
            ...
            <div v-if="newsletterError" class="max-w-md mx-auto bg-red-50 border border-red-200 rounded-lg p-4 mb-4" role="alert" aria-live="assertive">
                <div class="flex items-center">
                    <svg class="w-5 h-5 text-red-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <p class="text-red-700">{{ newsletterError }}</p>
                </div>
            </div>

            <form @submit.prevent="subscribeNewsletter" class="max-w-md mx-auto flex" aria-labelledby="newsletter-heading">
            ...
            <p class="text-xs text-neutral-500 dark:text-neutral-500 mt-4">Ao se inscrever, você concorda com nossa <a href="/terms-of-privacy" class="text-red-500 underline hover:text-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded">política de privacidade</a>.</p>
        </div>
    </section>

    <!-- Footer -->
    <footer class="bg-neutral-900 text-white pt-12 pb-6" role="contentinfo">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <a v-if="settings['blog.facebook']" :href="`https://facebook.com/${settings['blog.facebook']}`" target="_blank" class="text-neutral-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white rounded-full" aria-label="Facebook">
                        ...
                        <a v-if="settings['blog.twitter']" :href="`https://twitter.com/${settings['blog.twitter']}`" target="_blank" class="text-neutral-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white rounded-full" aria-label="Twitter">
                        ...
                        <a v-if="settings['blog.instagram']" :href="`https://instagram.com/${settings['blog.instagram']}`" target="_blank" class="text-neutral-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white rounded-full" aria-label="Instagram">
