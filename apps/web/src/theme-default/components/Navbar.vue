<template>
        ...
        <div class="h-full flex flex-col">
            <div class="p-2 border-b border-neutral-100 dark:border-neutral-800" v-if="settings">
                ...
                <div class="mt-1 flex items-center justify-center gap-4">
                    <a v-if="settings['blog.facebook']" :href="`https://facebook.com/${settings['blog.facebook']}`" target="_blank" rel="noopener noreferrer" 
                    ...
                    <a v-if="settings['blog.twitter']" :href="`https://twitter.com/${settings['blog.twitter']}`" target="_blank" rel="noopener noreferrer" 
                        class="flex items-center justify-center py-2 text-neutral-600 hover:text-neutral-800 dark:hover:text-neutral-400 rounded-md transition-colors"
                    ...
                    <a v-if="settings['blog.instagram']" :href="`https://instagram.com/${settings['blog.instagram']}`" target="_blank" rel="noopener noreferrer" 
                    class="flex items-center justify-center py-2 text-neutral-600 hover:text-neutral-800 dark:hover:text-neutral-400 rounded-md transition-colors"
                    ...
                    <a v-if="settings['blog.linkedin']" :href="`https://linkedin.com/in/${settings['blog.linkedin']}`" target="_blank" rel="noopener noreferrer" 
                        class="flex items-center justify-center py-2 text-neutral-600 hover:text-neutral-800 dark:hover:text-neutral-400 rounded-md transition-colors"
                    ...
                    <a v-if="settings['blog.github']" :href="`https://github.com/${settings['blog.github']}`" target="_blank" rel="noopener noreferrer" 
                        class="flex items-center justify-center py-2 text-neutral-600 hover:text-neutral-800 dark:hover:text-neutral-400 rounded-md transition-colors"
                    ...
                    <div v-if="isLoggedIn" class="flex items-center space-x-3">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center mt-1">
                                <a href="/member/profile" class="text-sm text-blue-400 hover:underline" aria-label="View your profile">Profile</a>
                                <span class="text-neutral-300 dark:text-neutral-400 mx-2">|</span>
                                <button @click="logout" class="text-sm text-blue-400 hover:underline" aria-label="Sign out from your account">Sign Out</button>
                            </div>
                        </div>
                    </div>
                    <div v-else class="flex items-center justify-center">
                        <div class="flex space-x-2">
                            <a href="/member/login" class="text-sm text-blue-400 hover:underline" aria-label="Sign in to your account">Sign In</a>
                            <span class="text-neutral-300 dark:text-neutral-600">|</span>
                            <a href="/member/register" class="text-sm text-neutral-600 dark:text-neutral-400 hover:underline" aria-label="Register a new account">Register</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <ul class="space-y-2">
                    <li v-for="category in categories" :key="category.id">
                        <a
                            ...
                            :aria-label="`View category: ${category.name} with ${category.postCount} posts`"
                        >
                            {{ category.name }}
            ...
            <div class="p-4 border-t border-neutral-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 flex justify-center">
                <a href="/terms-of-service" class="px-2 py-1 text-xs text-neutral-600 hover:text-blue-600 dark:text-neutral-400 dark:hover:text-blue-400 transition-colors" aria-label="Read terms of service">
                    Terms of Service
                </a>
                <span class="text-neutral-400 dark:text-neutral-600 self-center mx-1">|</span>
                <a href="/terms-of-privacy" class="px-2 py-1 text-xs text-neutral-600 hover:text-blue-600 dark:text-neutral-400 dark:hover:text-blue-400 transition-colors" aria-label="Read privacy policy">
                    Privacy Policy
                </a>
            </div>
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="w-full">
                            ...
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button @click="closeSearchModal" class="text-neutral-400 hover:text-neutral-500 focus:outline-none" aria-label="Close search">
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="w-full">
                            ...
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button @click="closeLoginModal" class="text-neutral-400 hover:text-neutral-500 focus:outline-none" aria-label="Close login form">
                                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                </button>
    ...
    <div v-if="isLoggedIn" class="fixed bottom-4 right-4 z-40 lg:hidden">
        ...
        <div v-if="profileDropdownOpen" class="absolute bottom-14 right-0 w-48 py-2 bg-white dark:bg-neutral-800 rounded-md shadow-lg border border-neutral-200 dark:border-neutral-700">
            <a href="/member/profile" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700" aria-label="View your profile">
                View Profile
            </a>
            <a href="/member/settings" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700" aria-label="Access account settings">
                Settings
            </a>
            <div class="border-t border-neutral-200 dark:border-neutral-700 my-1"></div>
            <button @click="logout" class="block w-full text-left px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700" aria-label="Sign out from your account">
                Sign Out
            </button>
        </div>
    </div>
