                                                ...
                                                >
                                                    <a :href="`/post/${relatedPost.slug}`" class="block">
                                                        <div class="h-48 overflow-hidden relative">
                                                            ...
                                                            <div v-if="relatedPost.categories && relatedPost.categories.length > 0" class="absolute top-2 left-2 flex flex-wrap gap-1">
                                                                <span v-for="category in relatedPost.categories" :key="category.id" class="bg-red-600 text-white px-2 py-1 rounded-md text-xs font-medium">
                                                                    {{ category.name }}
                                                                </span>
                                                            </div>
                                                        </div>
